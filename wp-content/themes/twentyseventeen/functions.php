...
function twentyseventeen_scripts() {
	...
	//wp_enqueue_script('jquery', '', array('json2'), '1.12.4');
...
//enregistrer une taxonomie
function creer_taxonomie(){
	register_taxonomy('regions', 'post', [
		'labels' => [
			'name' => 'Regions',
			'singular_name' => 'Region',
			'plural_name' => 'Regions',
			'search_items' => 'Rechercher une region' 
...
add_action('init', 'creer_taxonomie');
